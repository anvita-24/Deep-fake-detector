...
Synthetic media generated by Generative Adversarial Networks (GANs) has reached a level of visual fidelity where manipulated ("deepfake") videos are difficult to distinguish from genuine footage using the naked eye. This project implements an automated pipeline that ingests a video, isolates facial regions across sampled frames, and uses a hybrid CNN + GRU model to determine whether the content is **REAL** or **FAKE**.

The system is intended for:

- **Researchers** benchmarking deepfake-detection approaches
- **Platform trust & safety teams** exploring automated content moderation
- **Developers** who want a reference implementation for video-based binary classification with temporal modeling
...
> _Add screenshots or GIFs of the prediction pipeline here._

```
[ Placeholder: Input video preview ]
[ Placeholder: Extracted & aligned face frames ]
[ Placeholder: Prediction output with confidence score ]
```
